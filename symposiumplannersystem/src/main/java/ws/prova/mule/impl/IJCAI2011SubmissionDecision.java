...
public class IJCAI2011SubmissionDecision {

	public static ProvaConstant appropriate = null;

	public static String[] ijcailocations = { "Europe", "Spain", "Barcelona", "BRF 2011" , "BRF2011" };
	public static String[] ijcaiSubmissionCategory = { "phd paper","Full paper" };
	...
	private static void computeLocation(String country) {
		// TODO Auto-generated method stub
		if (findInArray(country, ijcailocations))
			ijcaievent += 1;
	}
