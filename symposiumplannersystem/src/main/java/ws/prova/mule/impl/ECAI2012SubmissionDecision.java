...
public class ECAI2012SubmissionDecision {

	public static ProvaConstant appropriate = null;

	public static String[] ecailocations = { "Europe", "France", "Montpellier", "ECAI 2012" , "ECAI2012" };
	public static String[] ecaiSubmissionCategory = { "phd paper","Full paper" };
	
	private static double ecaievent = 0;

	public static double decision(Object country,
	...
	private static void computeLocation(String country) {
		// TODO Auto-generated method stub
		if (findInArray(country, ecailocations))
			ecaievent += 1;
	}
