...
public class SymposiumPlannerSystemTestCase extends FunctionalTestCase
{
    protected String getConfigResources()
    {
        //TODO You'll need to edit this file to make the test applicable to your module
        return "mule-all-config.xml";
    }

    public void testSymposiumPlannerSystem() throws Exception
    {
