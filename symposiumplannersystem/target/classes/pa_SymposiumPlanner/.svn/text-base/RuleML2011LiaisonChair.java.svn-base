...
public class RuleML2011LiaisonChair extends HttpServlet {
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Liaison Chair Servlet RuleML-2011");
    out.println("Liaison Chair Servlet RuleML-2011");
