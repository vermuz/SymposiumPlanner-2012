...
public class RuleML2009LiaisonChair extends HttpServlet {
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Liaison Chair Servlet RuleML-2009");
    out.println("Liaison Chair Servlet RuleML-2009");
