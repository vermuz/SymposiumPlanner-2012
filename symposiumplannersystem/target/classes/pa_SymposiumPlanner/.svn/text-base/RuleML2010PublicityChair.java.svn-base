...
public class RuleML2010PublicityChair extends HttpServlet {

	private final String instantiation = "SymposiumPlanner10";
	private final String topic = "PublicityChair";
    ...
    public void doGet(HttpServletRequest request,
        ...
        //System.out.println("Publicty Chair Servlet RuleML-2010");
        //out.println("Publicty Chair Servlet RuleML-2010");
        ...
        System.out.println("Publicity Chair Servlet Console update:");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("Publicty Chair Servlet");
