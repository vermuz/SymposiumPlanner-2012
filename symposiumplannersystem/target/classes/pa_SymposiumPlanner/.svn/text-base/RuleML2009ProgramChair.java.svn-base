...
public class RuleML2009ProgramChair extends HttpServlet {

  public final static String FS = System.getProperty("file.separator");
 
  private final String instantiation = "SymposiumPlanner09";
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Panel Chair Servlet RuleML-2009");
    out.println("Panel Chair Servlet RuleML-2009");
