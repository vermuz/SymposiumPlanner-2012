...
public class IJCAI2011ProgramChair extends HttpServlet {

	public final static String FS = System.getProperty("file.separator");

	private final String instantiation = "ruleml2011ijcai";
	private final String topic = "ProgramChair";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Programming Chair Servlet RuleML-2011@IJCAI");
		out.println("Programming Chair Servlet RuleML-2011@IJCAI");
		...
		System.out.println("Programming Chair Servlet Console update:");
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			messageEndpoint = PAConfiguration.getEndpointName(instantiation,
					topic);
		...
		try {
			...
			while (solit.hasNext()) {
				...
				MessageGenerator g = new MessageGenerator(data, varSize,
						messageEndpoint, m.getId(), m.getProtocol(),
						m.getRel(), varOrder);
			...
			MessageGenerator g = new MessageGenerator(null, varSize,
					messageEndpoint, m.getId(), m.getProtocol(), m.getRel());
	...
	public static void main(String[] args) {
		IJCAI2011ProgramChair proChair = new IJCAI2011ProgramChair();
		proChair.answerQuery();
	}
