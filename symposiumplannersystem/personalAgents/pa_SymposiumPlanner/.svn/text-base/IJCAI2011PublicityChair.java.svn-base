...
public class IJCAI2011PublicityChair extends HttpServlet {
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("Publicty Chair Servlet RuleML-2011@IJCAI");
    out.println("Publicty Chair Servlet RuleML-2011@IJCAI");
