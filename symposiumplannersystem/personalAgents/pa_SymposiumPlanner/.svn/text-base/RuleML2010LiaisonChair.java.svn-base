...
public class RuleML2010LiaisonChair extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        //System.out.println("Liaison Chair Servlet RuleML-2010");
        //out.println("Liaison Chair Servlet RuleML-2010");
