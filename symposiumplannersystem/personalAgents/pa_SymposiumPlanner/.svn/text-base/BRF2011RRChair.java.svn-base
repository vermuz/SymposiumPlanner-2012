...
public class BRF2011RRChair extends HttpServlet {

	private final String instantiation = "ruleml2011brf";
	private final String topic = "RRChair";
    ...
    public void doGet(HttpServletRequest request,
        ...
        System.out.println("RR Chair Servlet RuleML-2011@BRF");
        out.println("RR Chair Servlet RuleML-2011@BRF");
        ...
        System.out.println("RR Chair Servlet Console update:");
