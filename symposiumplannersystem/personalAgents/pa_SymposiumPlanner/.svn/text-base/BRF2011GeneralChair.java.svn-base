...
public class BRF2011GeneralChair extends HttpServlet {

	private final String instantiation = "ruleml2011brf";
	private final String topic = "GeneralChair";
    ...
    public void doGet(HttpServletRequest request,
        ...
        System.out.println("General Chair Servlet RuleML-2011@BRF");
        out.println("General Chair Servlet RuleML-2011@BRF");
        ...
        System.out.println("General Chair Servlet Console update:");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            MessageGenerator g = new MessageGenerator(
                    null, varSize,messageEndpoint,
                    m.getId(), m.getProtocol(), m.getRel());
