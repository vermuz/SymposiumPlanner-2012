...
public class ECAI2012IntlRuleChalSteerCommitChair extends HttpServlet {

  public final static String FS = System.getProperty("file.separator");

  private final String instantiation = "ruleml2012ecai";
  private final String topic = "RuleChalSteerCommitChair";
 ...
 /////////////////////////
  ...
  public void doGet(HttpServletRequest request,
    ...
    System.out.println("International Rule Challenge Steering Committee Chair Servlet RuleML-2012@ECAI");
    out.println("International Rule Challenge Steering Committee Chair Servlet RuleML-2012@ECAI");
	...
	String date;	
 	...
 	System.out.println("International Rule Challenge Steering Committee Chair Servlet Console update:");
 ...
 /////////////////////////
    ...
    throws ServletException, IOException
  {
	  ...
	  catch(BadConfigurationException e) {System.out.println(e.getMessage());e.printStackTrace();System.exit(0);}
    response.setContentType("text/html; charset=UTF-8"); 	
    PrintWriter out = response.getWriter();
   
    try
    {	   	
    	System.out.println("5 International Rule Challenge Steering Committee Chair Servlet");
