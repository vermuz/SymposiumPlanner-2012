...
public class RuleML2008ChallengeChair extends HttpServlet {

	public final static String FS = System.getProperty("file.separator");

	private final String instantiation = "SymposiumPlanner08";
	private final String topic = "ChallengeChair";
	...
	public static String[] getVariableOrder(String message) {
		...
		for (int i = 0; i < variableList.length; i++) {
			System.out.println("RRRRRRRRRRRRRRRRRRR:"+variableList[i]);
		}
		return variableList;
	}
	...
	public static void main(String[] args) {
		RuleML2008ChallengeChair chair = new RuleML2008ChallengeChair();
		chair.answerQuery();
	}
