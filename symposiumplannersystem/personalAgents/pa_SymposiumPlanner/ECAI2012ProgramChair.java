...
public class ECAI2012ProgramChair extends HttpServlet {

	public final static String FS = System.getProperty("file.separator");

	private final String instantiation = "ruleml2012ecai";
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Programming Chair Servlet RuleML-2012@ECAI");
		out.println("Programming Chair Servlet RuleML-2012@ECAI");
	...
	public static void main(String[] args) {
		ECAI2012ProgramChair proChair = new ECAI2012ProgramChair();
